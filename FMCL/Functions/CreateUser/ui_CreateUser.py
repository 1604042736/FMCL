...
"}")
        ...
        self.pb_littleskin = TransparentTogglePushButton(self.f_panel)
        self.pb_littleskin.setMinimumSize(QtCore.QSize(0, 32))
        self.pb_littleskin.setCheckable(True)
        self.pb_littleskin.setAutoExclusive(True)
        self.pb_littleskin.setObjectName("pb_littleskin")
        self.gridLayout_2.addWidget(self.pb_littleskin, 2, 1, 1, 1)
    ...
    def retranslateUi(self, CreateUser):
        ...
        self.pb_littleskin.setText(_translate("CreateUser", "LittleSkin"))

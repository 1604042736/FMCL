...
"}")
        ...
        self.pb_screenshotmanager = TransparentTogglePushButton(self.f_panel)
        self.pb_screenshotmanager.setMinimumSize(QtCore.QSize(0, 32))
        self.pb_screenshotmanager.setAutoExclusive(True)
        self.pb_screenshotmanager.setObjectName("pb_screenshotmanager")
        self.gridLayout_2.addWidget(self.pb_screenshotmanager, 4, 0, 1, 1)
    ...
    def retranslateUi(self, GameManager):
        ...
        self.pb_screenshotmanager.setText(_translate("GameManager", "截图管理"))

...
class Ui_ModDetail(object):
    def setupUi(self, ModDetail):
        ...
        self.tb_modfiles = QtWidgets.QToolBox(self.groupBox_2)
        self.tb_modfiles.setObjectName("tb_modfiles")
        self.page_1 = QtWidgets.QWidget()
        self.page_1.setGeometry(QtCore.QRect(0, 0, 962, 474))
        self.page_1.setObjectName("page_1")
        self.tb_modfiles.addItem(self.page_1, "")
        self.gridLayout_3.addWidget(self.tb_modfiles, 0, 0, 1, 1)

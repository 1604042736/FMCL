...
class Ui_More(object):
    def setupUi(self, More):
        ...
        self.pb_openmcmodurl = QtWidgets.QPushButton(self.groupBox_2)
        self.pb_openmcmodurl.setObjectName("pb_openmcmodurl")
        self.gridLayout_3.addWidget(self.pb_openmcmodurl, 1, 1, 1, 1)
    ...
    def retranslateUi(self, More):
        ...
        self.label_2.setText(_translate("More", "MC百科: 提供Mod信息"))
        self.pb_openmcmodurl.setText(_translate("More", "打开网址"))

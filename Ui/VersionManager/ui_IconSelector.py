...
class Ui_IconSelector(object):
    def setupUi(self, IconSelector):
        ...
        self.tw_default.horizontalHeader().setDefaultSectionSize(64)
        self.tw_default.horizontalHeader().setHighlightSections(False)
        self.tw_default.horizontalHeader().setMinimumSectionSize(64)
        self.tw_default.verticalHeader().setVisible(False)
        self.tw_default.verticalHeader().setDefaultSectionSize(64)
        self.tw_default.verticalHeader().setMinimumSectionSize(64)

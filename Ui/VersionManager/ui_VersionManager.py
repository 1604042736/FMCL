...
class Ui_VersionManager(object):
    def setupUi(self, VersionManager):
        ...
        self.gridLayout_2.addWidget(self.l_fabricversion, 3, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pb_reinstall, 5, 0, 1, 1)

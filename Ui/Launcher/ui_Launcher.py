...
class Ui_Launcher(object):
    def setupUi(self, Launcher):
        ...
        self.gridLayout_2.addWidget(self.pb_chooseversion, 2, 0, 1, 1)
        self.pb_start = QtWidgets.QPushButton(self.widget)
        self.pb_start.setObjectName("pb_start")
        self.gridLayout_2.addWidget(self.pb_start, 1, 0, 1, 2)
        self.pb_manageversion = QtWidgets.QPushButton(self.widget)
        self.pb_manageversion.setObjectName("pb_manageversion")
        self.gridLayout_2.addWidget(self.pb_manageversion, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.quickWidget, 0, 0, 1, 2)

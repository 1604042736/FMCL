...
class Ui_Launcher(object):
    def setupUi(self, Launcher):
        ...
        self.gridLayout_2.addWidget(self.pb_chooseversion, 2, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pb_manageversion, 2, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.quickWidget, 0, 0, 1, 5)

...
class Ui_SettingWidget(object):
    def setupUi(self, SettingWidget):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 742, 593))
